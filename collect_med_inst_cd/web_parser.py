...
class BranchWebpageParser:
    ...
    def __init_branch_setting(self) -> dict:
        ...
        setting_dict = {
            ...
            BRANCH_HOKAIDO: ("https://kouseikyoku.mhlw.go.jp/hokkaido/gyomu/gyomu/hoken_kikan/code_ichiran.html",
                             {"class": "datatable"}, ("th", "医科"), href_excel_patt, None),
            # 東北  table.class="datatable", 医科row,医科(歯科併設)row - each_col=県, last_col=All県bundle(zip)
            BRANCH_TOHOKU: ("https://kouseikyoku.mhlw.go.jp/tohoku/gyomu/gyomu/hoken_kikan/itiran.html",
                            {"class": "datatable"}, ("th", "医科"), href_zip_patt, None),
            # 関東信越 table.class="datatable", each_row=県,last_row=All県bundle(zip), col=医科,歯科
            BRANCH_KANTO_SINETU: ("https://kouseikyoku.mhlw.go.jp/kantoshinetsu/chousa/shitei.html",
                                  {"class": "datatable"}, None, href_zip_patt, re.compile(r'^医科.*')),
            # 東海北陸  table.class="datatable", 医科row - each_col=県,last_col=All県bundle(zip)
            BRANCH_TOKAI_HOKURIKU: ("https://kouseikyoku.mhlw.go.jp/tokaihokuriku/gyomu/gyomu/hoken_kikan/shitei.html",
                                    {"class": "datatable"}, ("th", "医科"), href_zip_patt, None),
            # 近畿: table, 医科\n医科併設 row - each_col=県,last_col=All県bundle(zip)
            BRANCH_KINKI: ("https://kouseikyoku.mhlw.go.jp/kinki/tyousa/shinkishitei.html",
                           None, ("th", "医科"), href_zip_patt, None),
            # 四国: table.class="datatable", 医科row - each_col=県(excel)
            BRANCH_SHIKOKU: ("https://kouseikyoku.mhlw.go.jp/shikoku/gyomu/gyomu/hoken_kikan/shitei/index.html",
                             {"class": "datatable"}, ("th", "医科"), href_excel_patt, None),
            # 中国: table.class="datatable", thなし, each_col=県,last_col=All県bundle(zip,a_text='医科')
            BRANCH_CYUGOKU: ("https://kouseikyoku.mhlw.go.jp/chugokushikoku/chousaka/iryoukikanshitei.html",
                             {"class": "datatable"}, None, href_zip_patt, re.compile(r'^医科.*')),
            # 九州: table.class="datatable", each_td=県(zip.mix)
            BRANCH_KYUSYU: ("https://kouseikyoku.mhlw.go.jp/kyushu/gyomu/gyomu/hoken_kikan/index.html",
    ...
    def extract_file_urls(self, branch_id: int) -> list:
        ...
        url, table_class, child_of_tr_attr, href_patt, a_str = self._branch_setting_dict[branch_id]
